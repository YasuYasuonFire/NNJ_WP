...
__( 'The WordPress theme "OPINION" is a template for web media with a lot of information. The design utilizes tabs to make it easy to manage a wealth of contents. It is also ideal for media that publish a wide range of knowledge with multiple contributors.', 'tcd-opinion' );
...
<?php
  wp_enqueue_script('cf-media-field', get_template_directory_uri().'/admin/cf-media-field.js', '', '1', true); //画像アップロード用
}
